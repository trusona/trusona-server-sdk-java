...
public class Trusona implements TrusonaApi {
  ...
  /**
   * Create a user device binding in Trusona between a User and a Device, referenced by their identifiers. After creation, the
   * binding will be inactive, and must be explicitly activated before the User can use the Device to complete
   * Trusonafications.
   *
   * @param userIdentifier A unique identifier for the user. This will be how Trusona references your users, and should not
   * change.
  ...
  /**
   * Activates a user device binding in Trusona. After a binding is active, a user can respond to Trusonafications. Only call
   * this method after you have verified the identity of the user.
   *
  ...
  /**
   * Creates a Trusonafication and returns a TrusonaficationResult with the current status of the Trusonafication. See {@link
   * TrusonaficationStatus} for the possible statuses.
   *
  ...
  /**
   * Gets a TrusonaficationResult for a given Trusonafication ID. This will block until the Trusonafication is no longer
   * IN_PROGRESS
   *
