...
class DefaultAuthTokenParserSpec extends Specification {

  DefaultAuthTokenParser sut = new DefaultAuthTokenParser()

  def "parseToken should return a parsed token"() {
    given:
  ...
  def "parsedToken should return null if given a bad token"() {
    given:
    def token = "foobarfizzbuzz"
